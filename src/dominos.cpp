...
{
b2PolygonShape shape10;
      shape10.SetAsBox(2.0f, 2.0f);
      b2BodyDef bd10;
      bd10.position.Set(-20.0f, 2.0f);
      bd10.type = b2_dynamicBody;
      b2Body* body10 = m_world->CreateBody(&bd10);
      b2FixtureDef *fd10 = new b2FixtureDef;
      fd10->density = 10.0f;
      //fd10->restitution = 100.0f;
      fd10->friction=0.0f;
      fd10->shape = new b2PolygonShape;
      fd10->shape = &shape10;
      body10->CreateFixture(fd10);

b2PolygonShape shape11;
      shape11.SetAsBox(2.0f, 2.0f);
      b2BodyDef bd11;
      bd11.position.Set(-13.0f, 2.0f);
      bd11.type = b2_dynamicBody;
      b2Body* body11 = m_world->CreateBody(&bd11);
      ...
      fd11->shape = &shape11;
      body11->CreateFixture(fd11);

b2DistanceJointDef* distance_joint = new b2DistanceJointDef();
//b2DistanceJoint dJoint;
b2Vec2 anchor1;
anchor1.Set(-20.0, 2.0);
b2Vec2 anchor2;
anchor2.Set(-13.0, 2.0);
/*distance_joint->body1 = body10;

distance_joint->body2 = body11;
